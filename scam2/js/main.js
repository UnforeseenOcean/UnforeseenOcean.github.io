...
// You look stupid with that face.
    ...
    function loading_step() {
        ...
        $('#resources-select-wrapper').fadeOut(500, function() {
            $('#processing-wrapper').fadeIn(500, function() {
                ...
                setTimeout(function() {
                    $console_message.html("Asserting <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> is a loser");
                ...
                setTimeout(function() {
                    $console_message.html("Dispensing <span class='console-message-connected-item'>" + $console_message_futcoins_msg + "</span> times of anal sex");
                ...
                setTimeout(function() {
                    $console_message.html("I am a little teapot, short and stout");
                ...
                setTimeout(function() {
                    $console_message.html("<span class='console-message-connected-item'>Seriously?</span>");
                    $(".console-message").addClass('pulse animated').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
                        $(this).removeClass('pulse animated');
                    });
                ...
                setTimeout(function() {
                    ...
                    $console_message.html("Are you really this stupid?");
                    if ($(window).width() < 600) {
